...
OHOSContextGLSkia::OHOSContextGLSkia(fml::RefPtr<OHOSEnvironmentGL> environment,
                                     const TaskRunners& task_runners)
    : OHOSContext(OHOSRenderingAPI::kSkiaOpenGLES),
...
EGLContext OHOSContextGLSkia::GetEGLContext() const {
  return context_;
}

EGLDisplay OHOSContextGLSkia::GetEGLDisplay() const {
