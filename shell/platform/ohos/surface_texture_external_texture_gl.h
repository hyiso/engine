...
#ifndef FLUTTER_SHELL_PLATFORM_OHOS_SURFACE_TEXTURE_EXTERNAL_TEXTURE_GL_H_
#define FLUTTER_SHELL_PLATFORM_OHOS_SURFACE_TEXTURE_EXTERNAL_TEXTURE_GL_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_OHOS_SURFACE_TEXTURE_EXTERNAL_TEXTURE_GL_H_
