...
class OHOSContextGLImpeller::ReactorWorker final
...
OHOSContextGLImpeller::OHOSContextGLImpeller(
    ...
    bool enable_gpu_tracing)
    : OHOSContext(OHOSRenderingAPI::kImpellerOpenGLES),
...
OHOSContextGLImpeller::~OHOSContextGLImpeller() = default;

bool OHOSContextGLImpeller::IsValid() const {
  return is_valid_;
}

bool OHOSContextGLImpeller::ResourceContextClearCurrent() {
...
bool OHOSContextGLImpeller::ResourceContextMakeCurrent(
...
OHOSContextGLImpeller::CreateOffscreenSurface() {
  return display_->CreatePixelBufferSurface(*offscreen_config_, 1u, 1u);
}

bool OHOSContextGLImpeller::OnscreenContextMakeCurrent(
...
bool OHOSContextGLImpeller::OnscreenContextClearCurrent() {
...
std::unique_ptr<impeller::egl::Surface>
OHOSContextGLImpeller::CreateOnscreenSurface(EGLNativeWindowType window) {
